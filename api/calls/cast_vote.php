...
// Check if expected json sent
 ...
 $exp = array("election_id", "user_id", "code", "vote");
...
$clean = new na_clean;
$user_id = $clean->clean_str($user_id);
$election_id = $clean->clean_str($election_id);
$election_id = strtolower($election_id);
$code = $clean->clean_str($code);
$vote = $clean->clean_str2($vote);

//Query database
$query = new na_vote;
$result = $query->cast_vote($election_id, $user_id, $code, $vote);
